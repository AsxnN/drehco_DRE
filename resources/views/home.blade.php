...
application/x-httpd-php home.blade.php ( HTML document, UTF-8 Unicode text, with very long lines, with CRLF line terminators )
...
@section('content')
                ...
                <div class="col-md-10 py-1">
                    <section class="p-0">
                            <div class="opciones_hero">
                                ...
                                <div class="opciones_hero_div galeria">
                         ...
                         <!--   <div class="col-lg-2 col-md-2 col-6">
                                <div class="single_categories">
                                    <a href="{{route('directorioweb')}}" class="bg_danger small p-3"><i class="fa fa-desktop"></i>Directorio Institucional</a>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-2 col-6">
                                <div class="single_categories">
                                    <a href="/resoluciones" class="bg_light_green small p-3"><i class="fa fa-chart-line"></i>Resoluciones</a>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-2 col-6">
                                <div class="single_categories">
                                    <a href="{{route('documentosdegestionweb')}}" class="bg_default small p-3"><i class="fa fa-book"></i>Gestion de Documentos</a>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-2 col-6">
                                <div class="single_categories">
                                    <a href="{{route('galerias')}}" class="bg_pink small p-3"><i class="fa fa-camera"></i>Galeria de Imagenes</a>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-2 col-6">
                                <div class="single_categories">
                                    <a href="#" class="bg_blue small p-3"><i class="fa fa-heartbeat"></i>Integridad</a>
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-2 col-6">
                                <div class="single_categories">
                                    <a href="#" class="bg_orange small p-3"><i class="fa fa-code"></i>SIAGIE</a>
                                </div>
                            </div> -->
            
                        <div class="opciones_hero">
                            <div class="opciones_hero_div presupuesto">
                                    <a href="https://www.transparencia.gob.pe/reportes_directos/pte_transparencia_info_finan.aspx?id_entidad=14163&id_tema=19&ver=" target="_blank" class="">
                            ...
                            <div class="opciones_hero_div registro-visitas">
                                <a href="https://www.transparencia.gob.pe/reportes_directos/pte_transparencia_reg_visitas.aspx?id_entidad=14163&ver=&id_tema=500" target="_blank" class="small p-3"><svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960" width="40px" fill="#000000"><path d="M228.45-268.97q58.62-41.2 120.2-63.62Q410.23-355 480.2-355q69.98 0 132.31 22.99 62.34 22.98 119.71 63.23 39.68-50.23 57.57-101.49 17.89-51.25 17.89-109.73 0-138.08-94.78-232.88-94.78-94.8-232.83-94.8-138.06 0-232.9 94.8-94.85 94.8-94.85 232.88 0 58.26 17.95 109.42 17.95 51.16 58.18 101.61Zm251.43-173.36q-60.16 0-100.9-40.81-40.75-40.8-40.75-100.71 0-59.9 40.87-100.87 40.87-40.96 101.02-40.96 60.16 0 100.9 41.09 40.75 41.08 40.75 100.99 0 59.9-40.87 100.59-40.87 40.68-101.02 40.68Zm.2 378.16q-85.62 0-161.4-32.65t-132.49-89.35q-56.71-56.7-89.37-132.36-32.65-75.67-32.65-161.69 0-85.61 32.73-161.29 32.72-75.68 89.32-132.27 56.59-56.6 132.27-89.51 75.69-32.91 161.73-32.91 85.61 0 161.29 32.91 75.68 32.91 132.27 89.51 56.6 56.59 89.51 132.34 32.91 75.75 32.91 161.36 0 85.62-32.91 161.44-32.91 75.83-89.51 132.42-56.59 56.6-132.34 89.32-75.75 32.73-161.36 32.73Zm-.08-88.15q52.26 0 99.91-14.61 47.66-14.61 94.66-49.06-47.76-32.72-94.9-49.05-47.13-16.32-99.67-16.32t-99.39 16.32q-46.86 16.33-94.61 49.05 47 34.45 94.37 49.06 47.37 14.61 99.63 14.61Zm0-364.03q29.4 0 48.48-18.87 19.09-18.87 19.09-48.5 0-29.64-19.09-48.79-19.08-19.16-48.48-19.16t-48.48 19.16q-19.09 19.15-19.09 48.79 0 29.63 19.09 48.5 19.08 18.87 48.48 18.87Zm0-67.56Zm.57 367.26Z"/>
                                </svg><br>
                                    REGISTRO DE VISITAS
                                </a>
                            </div>
                            <div class="opciones_hero_div aprende-huanuco">
                                <a href="#" >
                            ...
                            <div class="opciones_hero_div boletin-informativo">
                            ...
                            <div class="opciones_hero_div directorio-dre-ugel">
                            ...
                            <div class="opciones_hero_div agenda-directoral">
                    ...
                    <section class="pt-0">
                        <div class="w-full h-full">
                                ...
                                <div class="container-card">
                                    <section class="pt-5 pb-5">
                                        <div class="container-card">
                                            <div class="row ">
                                                <div class="col-6">
                                                    <a href="{{route('allnoticias')}}" class="btn btn-primary btncor">Ver más noticias</a>
                                                </div>
                                                <div class="col-6 text-right">
                                                    <a class="btn btn-primary mb-3 mr-1 btncor" href="#carouselExampleIndicators2" role="button" data-slide="prev">
                                                        <i class="fa fa-arrow-left"></i>
                                                    </a>
                                                    <a class="btn btn-primary mb-3 btncor" href="#carouselExampleIndicators2" role="button" data-slide="next">
                                                ...
                                                <div class="col-12">
                                                    <div id="carouselExampleIndicators2" class="carousel slide" data-ride="carousel">
                                                        <div class="carousel-inner">
                                                            @foreach($noticias->chunk(3) as $chunk)
                                                                        ...
                                                                        @foreach ($chunk as $item)
                                                                            <div class="col-md-4 mb-3">
                                                                                <div class="card card-text">
                                                                                    <div>
                                                                                        <img class="img-fluid" alt="100%x280" src="{{ asset('img/post_noticias/'.$item->img1) }}" loading="lazy">
                                                                                    </div>
                                                                                    <div class="card-body">
                                                                                        <h3 class="txt-ah3">{{ $item->titulo }}</h3>
                                                                                        <ul class="post-categories txt-uno">
                                                                                            ...
                                                                                            <div class="div-card text-center">
                                                                                                <a href="{{ route('noticia', $item->id) }}" rel="category tag">Ver Más</a>
                                                                                            </div>
                                                                                        </ul>
                                                                                    </div>
                                                                                </div>
                            ...
                            <section class="ptt">
                                <div class="opciones_hero1">
            
                                    @foreach ($mainrightitem as $item)
                                    <div class="opciones_hero_div1 directorio cont-img">
                                        <a href="{{$item->url}}" target="_blank" class="btn btn-primary p-0" title="{{$item->nombre}}">
                                          <img src="{{asset('img/mainright/'.$item->imagen)}}" alt="{{$item->nombre}}" class="img-contenida">
                                        </a>
                                      </div>
                                            ...
                                            <div class="banner-inner card">
                                                <div class="card-body gutter-left">
                                                    <div class="owl-carousel cm_banner-carousel-five">
                                                        @foreach ($noticias as $item)
                                                            <div class="item">
                                                                <div class="post_thumb" style="background-image: url({{ asset('img/post_noticias/'.$item->img1) }})">
                                                                    <div class="post-holder">
                                                                        <div class="entry_cats">
                                                                            <ul class="post-categories">
                                                                                <li><a href="{{route('noticia', $item->id)}}" rel="category tag">Ver Más</a></li>
                                                                            </ul>
                                                                        </div>
        ...
        <section class="bg_gray mt-1 section_2">
            <div class="w-full h-full">
                <div class="row">
                    <!-- Espacio lateral izquierdo -->
                    <div class="col-md-1 d-none d-md-block"></div>
        
                    <!-- Contenido principal (Galería + Facebook) -->
                    <div class="col-md-10">
                        <div class="row">
                            <!-- Galería de Videos -->
